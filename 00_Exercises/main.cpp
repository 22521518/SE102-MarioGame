...
#define TEXTURE_PATH_GUN L"gun.png"

#define BRICK_START_VX 0.2f

#define BRICK_WIDTH 32.0f
#define BRICK_HEIGHT 32.0f
#define GUN_WIDTH 26.0f
#define GUN_HEIGHT 41.0f

#define BRICK_START_X WINDOW_WIDTH / 2 - BRICK_WIDTH 
#define BRICK_START_Y BRICK_HEIGHT
...
void Update(DWORD dt)
{
	...
	brickSprite->Update(dt, BackBufferWidth, BackBufferHeight);
}
...
)
{
	...
	InitDirectX(hWnd);
	brickSprite = new CGun(pD3DDevice, spriteObject, BRICK_START_X, BRICK_START_Y, BRICK_START_VX, 0, GUN_WIDTH, GUN_HEIGHT, TEXTURE_PATH_GUN);
	LoadResources();
	Run();
	Cleanup();
